...
namespace Microsoft.Automata
{
    ...
    // use only INCR, EXIT_SET0, EXIT_SET1
        ...
        string LowerBoundCheck
        {
            get
            {
                if (Counter.LowerBound > 0)
                    ...
                    return "(c" + SpecialCharacters.ToSubscript(Counter.CounterId) + ")";
                else
                    return "";
            }
        }
        ...
        public override string ToString()
        {
            switch (elems.Item2)
            {
                /// case CounterOp.EXIT:
                 ...
                 case CounterOp.SET0:
                    return string.Format("SET0({0})", SpecialCharacters.c(Counter.CounterId), SpecialCharacters.ASSIGN);
                //return string.Format("SET0({0})", SpecialCharacters.c(Counter.CounterId), SpecialCharacters.ASSIGN);
                ...
                case CounterOp.SET1:
                     return string.Format("SET1({0})", SpecialCharacters.c(Counter.CounterId), SpecialCharacters.ASSIGN);
               ...
               //  default:
                 ...
                 case CounterOp.EXIT:
                    //return LowerBoundCheck;
                    //return string.Format("{2}{3}EXIT({0})", SpecialCharacters.c(Counter.CounterId), SpecialCharacters.CIRCLE, LowerBoundCheck, SpecialCharacters.IMPLIES);
                    return string.Format("EXIT({0})", SpecialCharacters.c(Counter.CounterId), SpecialCharacters.CIRCLE, LowerBoundCheck, SpecialCharacters.IMPLIES);
                case CounterOp.EXIT_SET1:
                    return string.Format("{2}{3}EXIT{1}SET1({0})", SpecialCharacters.c(Counter.CounterId), SpecialCharacters.CIRCLE, LowerBoundCheck, SpecialCharacters.IMPLIES);
                    //return string.Format("EXIT{1}SET1({0})", SpecialCharacters.c(Counter.CounterId), SpecialCharacters.CIRCLE, LowerBoundCheck, SpecialCharacters.IMPLIES);
                case CounterOp.INCR:
                     //   return string.Format("{2}{3}INCR({0})", SpecialCharacters.c(Counter.CounterId), SpecialCharacters.ASSIGN, UpperBoundCheck, SpecialCharacters.IMPLIES);
                    return string.Format("INCR({0})", SpecialCharacters.c(Counter.CounterId), SpecialCharacters.ASSIGN, UpperBoundCheck, SpecialCharacters.IMPLIES);
