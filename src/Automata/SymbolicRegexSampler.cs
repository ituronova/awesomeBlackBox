...
namespace Microsoft.Automata
{
    class SymbolicRegexSampler<S>
    {
        ...
        // Probability of generating a part of the match.
        private int stopProb;
        ...
        public SymbolicRegexSampler(SymbolicRegexBuilder<S> builder, SymbolicRegexNode<S> sr, int maxUnroll, int cornerCaseProb = 5, int maxSamplingIter = 3, int stopProb = 5)
        {
        ...
        string GenerateRandomMember(SymbolicRegexBuilder<S> builder, SymbolicRegexNode<S> root)
        {
            ...
            while (nodeQueue.Count > 0 || curNode != null)
            {
              ...
              /*  continueOn = rand.Next(100);
                if (continueOn < stopProb)
                {
                    notDone += 1;
                    return sample;
                }*/
