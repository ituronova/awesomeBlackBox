...
namespace Microsoft.Automata.Z3
{
    ...
    public class Z3Provider : IContext<FuncDecl,Expr,Sort>
    {
       ...
       /// <returns></returns>
        ...
        Sort IContext<FuncDecl, Expr, Sort>.BoolSort
        {
            get
            {
                throw new NotImplementedException();
        ...
        Sort IContext<FuncDecl, Expr, Sort>.IntSort
        {
            get
            {
                throw new NotImplementedException();
        ...
        Sort IContext<FuncDecl, Expr, Sort>.UnitSort
        {
            get
            {
                throw new NotImplementedException();
        ...
        Expr IContext<FuncDecl, Expr, Sort>.UnitConst
        {
            get
            {
                throw new NotImplementedException();
        ...
        IRegexConverter<Expr> IContext<FuncDecl, Expr, Sort>.RegexConverter
        {
            get
            {
                throw new NotImplementedException();
        ...
        Chooser IContext<FuncDecl, Expr, Sort>.Chooser
        {
            get
            {
                throw new NotImplementedException();
        ...
        Sort IContext<FuncDecl, Expr, Sort>.CharSort
        {
            get
            {
                throw new NotImplementedException();
        ...
        ILibrary<Expr> IContext<FuncDecl, Expr, Sort>.Library
        {
            get
            {
                throw new NotImplementedException();
        ...
        ISolver<Expr> IContextCore<Expr>.MainSolver
        {
            get
            {
                throw new NotImplementedException();
        ...
        BitWidth ICharAlgebra<Expr>.Encoding
        {
            get
            {
                throw new NotImplementedException();
        ...
        CharSetSolver ICharAlgebra<Expr>.CharSetProvider
        {
            get
            {
                throw new NotImplementedException();
        ...
        bool IBooleanAlgebra<Expr>.IsExtensional
        {
            get
            {
                throw new NotImplementedException();
        ...
        bool IBooleanAlgebra<Expr>.IsAtomic
        {
            get
            {
                throw new NotImplementedException();
        ...
        Expr IBooleanAlgebraPositive<Expr>.True
        {
            get
            {
                throw new NotImplementedException();
        ...
        Expr IBooleanAlgebraPositive<Expr>.False
        {
            get
            {
                throw new NotImplementedException();
        ...
        Sort IContext<FuncDecl, Expr, Sort>.MkBitVecSort(uint bits)
        {
            throw new NotImplementedException();
        }

        Sort IContext<FuncDecl, Expr, Sort>.GetSort(Expr term)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkVar(uint index, Sort sort)
        {
            throw new NotImplementedException();
        }

        bool IContext<FuncDecl, Expr, Sort>.IsVar(Expr v)
        {
            throw new NotImplementedException();
        }

        uint IContext<FuncDecl, Expr, Sort>.GetVarIndex(Expr v)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkConst(string name, Sort sort)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkFreshConst(string prefix, Sort sort)
        {
            throw new NotImplementedException();
        }

        IEnumerable<Expr> IContext<FuncDecl, Expr, Sort>.GetVars(Expr t)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkNumeral(int n, Sort sort)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkNumeral(uint n, Sort sort)
        {
            throw new NotImplementedException();
        }

        uint IContext<FuncDecl, Expr, Sort>.GetNumeralUInt(Expr t)
        {
            throw new NotImplementedException();
        }

        int IContext<FuncDecl, Expr, Sort>.GetNumeralInt(Expr t)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkHexProj(int n, Expr c)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkHexProj(int n, Expr c, Sort resSort)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.ConvertBitVector(Expr bv, Sort s)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkBvExtract(uint high, uint low, Expr bv)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkBvAnd(Expr bv1, Expr bv2)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkBvOr(Expr bv1, Expr bv2)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkBvShiftRight(uint i, Expr bv)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkBvShiftLeft(uint i, Expr bv)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkBvAdd(Expr bv1, Expr bv2)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkBvMul(Expr bv1, Expr bv2)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkBvSub(Expr bv1, Expr bv2)
        {
            throw new NotImplementedException();
        }

        Sort[] IContext<FuncDecl, Expr, Sort>.GetDomain(FuncDecl f)
        {
            throw new NotImplementedException();
        }

        Sort IContext<FuncDecl, Expr, Sort>.GetRange(FuncDecl f)
        {
            throw new NotImplementedException();
        }

        FuncDecl IContext<FuncDecl, Expr, Sort>.MkFreshFuncDecl(string f, Sort[] domSorts, Sort ranSort)
        {
            throw new NotImplementedException();
        }

        FuncDecl IContext<FuncDecl, Expr, Sort>.MkFuncDecl(string f, Sort[] domSorts, Sort ranSort)
        {
            throw new NotImplementedException();
        }

        FuncDecl IContext<FuncDecl, Expr, Sort>.MkFuncDecl(string f, Sort domain, Sort range)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkApp(FuncDecl f, params Expr[] args)
        {
            throw new NotImplementedException();
        }

        Expr[] IContext<FuncDecl, Expr, Sort>.GetAppArgs(Expr t)
        {
            throw new NotImplementedException();
        }

        string IContext<FuncDecl, Expr, Sort>.GetDeclName(FuncDecl f)
        {
            throw new NotImplementedException();
        }

        string IContext<FuncDecl, Expr, Sort>.GetDeclShortName(FuncDecl f)
        {
            throw new NotImplementedException();
        }

        uint[] IContext<FuncDecl, Expr, Sort>.GetDeclParameters(FuncDecl f)
        {
            throw new NotImplementedException();
        }

        Sort IContext<FuncDecl, Expr, Sort>.MkListSort(Sort elemSort)
        {
            throw new NotImplementedException();
        }

        bool IContext<FuncDecl, Expr, Sort>.IsListSort(Sort sort)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.GetNil(Sort listSort)
        {
            throw new NotImplementedException();
        }

        Sort IContext<FuncDecl, Expr, Sort>.GetElemSort(Sort listSort)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkList(params Expr[] ts)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkListFromString(string inputElems, Sort elemSort)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkListWithRest(Expr[] elems, Expr rest)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkListCons(Expr first, Expr rest)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkFirstOfList(Expr list)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkIsCons(Expr list)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkIsNil(Expr list)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkRestOfList(Expr list)
        {
            throw new NotImplementedException();
        }

        Sort IContext<FuncDecl, Expr, Sort>.MkTupleSort(params Sort[] elemSorts)
        {
            throw new NotImplementedException();
        }

        bool IContext<FuncDecl, Expr, Sort>.IsTupleSort(Sort sort)
        {
            throw new NotImplementedException();
        }

        int IContext<FuncDecl, Expr, Sort>.GetTupleLength(Sort tupleSort)
        {
            throw new NotImplementedException();
        }

        Sort IContext<FuncDecl, Expr, Sort>.GetTupleElementSort(Sort tupleSort, int p)
        {
            throw new NotImplementedException();
        }

        Sort IContext<FuncDecl, Expr, Sort>.MkOptionSort(Sort s)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkNone(Sort s)
        {
            throw new NotImplementedException();
        }

        Sort IContext<FuncDecl, Expr, Sort>.GetOptionValueSort(Sort s)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkSome(Expr t)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkIsSome(Expr t)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkIsNone(Expr t)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkGetSomeValue(Expr t)
        {
            throw new NotImplementedException();
        }

        bool IContext<FuncDecl, Expr, Sort>.IsOption(Sort s)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkCharGe(Expr x, Expr y)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkCharGt(Expr x, Expr y)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkCharLe(Expr x, Expr y)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkCharLt(Expr x, Expr y)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkCharLSHB(Expr c)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkCharAdd(Expr x, Expr y)
        {
            throw new NotImplementedException();
        }

        char IContext<FuncDecl, Expr, Sort>.GetCharValue(Expr t)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkCharExpr(char c)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkCharVar(uint id)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkCharRem(Expr x, Expr y)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkCharDiv(Expr x, Expr y)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkCharSub(Expr x, Expr y)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkCharMul(Expr x, Expr y)
        {
            throw new NotImplementedException();
        }

        FuncDecl IContext<FuncDecl, Expr, Sort>.GetTupleConstructor(Sort tupleSort)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkExists(Expr body, params Expr[] vars)
        {
            throw new NotImplementedException();
        }

        Expr IContext<FuncDecl, Expr, Sort>.MkZeroExt(uint i, Expr t)
        {
            throw new NotImplementedException();
        }

        Expr IContextCore<Expr>.MkTuple(params Expr[] ts)
        {
            throw new NotImplementedException();
        }

        Expr IContextCore<Expr>.MkProj(int p, Expr z)
        {
            throw new NotImplementedException();
        }

        Expr IContextCore<Expr>.MkIte(Expr cond, Expr t, Expr f)
        {
            throw new NotImplementedException();
        }

        Expr IContextCore<Expr>.MkInt(int n)
        {
            throw new NotImplementedException();
        }

        Expr IContextCore<Expr>.MkFreshConst(string prefix, Expr t)
        {
            throw new NotImplementedException();
        }

        bool IContextCore<Expr>.IsGround(Expr t)
        {
            throw new NotImplementedException();
        }

        Expr IContextCore<Expr>.MkEq(Expr t1, Expr t2)
        {
            throw new NotImplementedException();
        }

        Expr IContextCore<Expr>.MkNeq(Expr t1, Expr t2)
        {
            throw new NotImplementedException();
        }

        Expr IContextCore<Expr>.ApplySubstitution(Expr t, Expr key, Expr val)
        {
            throw new NotImplementedException();
        }

        Expr IContextCore<Expr>.ApplySubstitution(Expr t, Expr key_1, Expr val_1, Expr key_2, Expr val_2)
        {
            throw new NotImplementedException();
        }

        Expr IContextCore<Expr>.ApplySubstitution(Expr t, IDictionary<Expr, Expr> substitution)
        {
            throw new NotImplementedException();
        }

        Expr IContextCore<Expr>.ToNNF(Expr t)
        {
            throw new NotImplementedException();
        }

        Expr IContextCore<Expr>.MkAxiom(Expr lhs, Expr rhs, params Expr[] vars)
        {
            throw new NotImplementedException();
        }

        ISolver<Expr> IContextCore<Expr>.MkSolver(string logic)
        {
            throw new NotImplementedException();
        }

        Expr ICharAlgebra<Expr>.MkRangeConstraint(char lower, char upper, bool caseInsensitive)
        {
            throw new NotImplementedException();
        }

        Expr ICharAlgebra<Expr>.MkCharConstraint(char c, bool caseInsensitive)
        {
            throw new NotImplementedException();
        }

        Expr ICharAlgebra<Expr>.MkRangesConstraint(bool caseInsensitive, IEnumerable<char[]> ranges)
        {
            throw new NotImplementedException();
        }

        Expr ICharAlgebra<Expr>.ConvertFromCharSet(BDD set)
        {
            throw new NotImplementedException();
        }

        ulong ICharAlgebra<Expr>.ComputeDomainSize(Expr set)
        {
            throw new NotImplementedException();
        }

        IEnumerable<char> ICharAlgebra<Expr>.GenerateAllCharacters(Expr set)
        {
            throw new NotImplementedException();
        }

        BDD ICharAlgebra<Expr>.ConvertToCharSet(IBDDAlgebra solver, Expr pred)
        {
            throw new NotImplementedException();
        }

        Expr ICharAlgebra<Expr>.MkCharPredicate(string name, Expr pred)
        {
            throw new NotImplementedException();
        }

        Expr ICharAlgebra<Expr>.MkSet(uint e)
        {
            throw new NotImplementedException();
        }

        uint ICharAlgebra<Expr>.Choose(Expr s)
        {
            throw new NotImplementedException();
        }

        char ICharAlgebra<Expr>.ChooseUniformly(Expr s)
        {
            throw new NotImplementedException();
        }

        Expr[] ICharAlgebra<Expr>.GetPartition()
        {
            throw new NotImplementedException();
        }

        string ICharAlgebra<Expr>.SerializePredicate(Expr s)
        {
            throw new NotImplementedException();
        }

        Expr ICharAlgebra<Expr>.DeserializePredicate(string s)
        {
            throw new NotImplementedException();
        }

        int ICharAlgebra<Expr>.MintermIndex(Expr s)
        {
            throw new NotImplementedException();
        }

        Expr IBooleanAlgebra<Expr>.MkOr(IEnumerable<Expr> predicates)
        {
            throw new NotImplementedException();
        }

        Expr IBooleanAlgebra<Expr>.MkAnd(IEnumerable<Expr> predicates)
        {
            throw new NotImplementedException();
        }

        Expr IBooleanAlgebra<Expr>.MkAnd(params Expr[] predicates)
        {
            throw new NotImplementedException();
        }

        Expr IBooleanAlgebra<Expr>.MkNot(Expr predicate)
        {
            throw new NotImplementedException();
        }

        Expr IBooleanAlgebra<Expr>.MkDiff(Expr predicate1, Expr predicate2)
        {
            throw new NotImplementedException();
        }

        bool IBooleanAlgebra<Expr>.AreEquivalent(Expr predicate1, Expr predicate2)
        {
            throw new NotImplementedException();
        }

        Expr IBooleanAlgebra<Expr>.MkSymmetricDifference(Expr p1, Expr p2)
        {
            throw new NotImplementedException();
        }

        bool IBooleanAlgebra<Expr>.CheckImplication(Expr lhs, Expr rhs)
        {
            throw new NotImplementedException();
        }

        Expr IBooleanAlgebra<Expr>.Simplify(Expr predicate)
        {
            throw new NotImplementedException();
        }

        Expr IBooleanAlgebra<Expr>.GetAtom(Expr psi)
        {
            throw new NotImplementedException();
        }

        bool IBooleanAlgebra<Expr>.EvaluateAtom(Expr atom, Expr psi)
        {
            throw new NotImplementedException();
        }

        IEnumerable<Tuple<bool[], Expr>> IBooleanAlgebra<Expr>.GenerateMinterms(params Expr[] constraints)
        {
            throw new NotImplementedException();
        }

        Expr IBooleanAlgebraPositive<Expr>.MkAnd(Expr predicate1, Expr predicate2)
        {
            throw new NotImplementedException();
        }

        Expr IBooleanAlgebraPositive<Expr>.MkOr(Expr predicate1, Expr predicate2)
        {
            throw new NotImplementedException();
        }

        bool IBooleanAlgebraPositive<Expr>.IsSatisfiable(Expr predicate)
        {
            throw new NotImplementedException();
        }

        string IPrettyPrinter<Expr>.PrettyPrint(Expr t)
        {
            throw new NotImplementedException();
        }

        string IPrettyPrinter<Expr>.PrettyPrint(Expr t, Func<Expr, string> varLookup)
        {
            throw new NotImplementedException();
        }

        string IPrettyPrinter<Expr>.PrettyPrintCS(Expr t, Func<Expr, string> varLookup)
        {
            throw new NotImplementedException();
        }
